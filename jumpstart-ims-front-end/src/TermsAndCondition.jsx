...
return (
<div>
    <div className="border border-top-0 border-start-0 border-end-0 border-dark p-3 position-sticky top-0 bg-secondary"
        style={{width: "100vw"}}>
    ...
    <div className="m-4">
        ...
        <p>These terms and conditions outline the rules and regulations for the use of Jumpstart's Website, located at
            http://localhost/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use localhost
            if
        ...
        <p>We employ the use of cookies. By accessing localhost, you agreed to use cookies in agreement with the
            Jumpstart's
            Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Jumpstart and/or its licensors own the intellectual property rights for all material
            on
            localhost. All intellectual property rights are reserved. You may access this from localhost for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from localhost</li>
            <li>Sell, rent or sub-license material from localhost</li>
            <li>Reproduce, duplicate or copy material from localhost</li>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Jumpstart does not filter, edit, publish or review Comments prior to their presence on
            the
            website. Comments do not reflect the views and opinions of Jumpstart,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, Jumpstart shall not be liable for the Comments or for any liability, damages or expenses
            caused
            and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.
        </p>

        <p>Jumpstart reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Jumpstart a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Jumpstart; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to Jumpstart. Please include your name, your organization name, contact
        ...
        <p>No use of Jumpstart's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
